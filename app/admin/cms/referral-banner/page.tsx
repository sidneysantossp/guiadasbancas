...
export default function ReferralBannerAdminPage() {
  const [mounted, setMounted] = useState(false);
  const [banner, setBanner] = useState<ReferralBanner>({
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Banner de Indicação</h1>
        <p className="text-gray-600">Configure o banner de indicação da plataforma que aparece na parte inferior da home</p>
      </div>
