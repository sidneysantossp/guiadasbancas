          ...
          <div className="mt-4">
            ...
            <div className="mt-2 rounded-xl border border-amber-200 bg-amber-50 p-3 text-sm">
              ...
              <div className="text-gray-900">
                {order.address?.street}{order.address?.houseNumber ? `, ${order.address.houseNumber}` : ""}
                {order.address?.neighborhood ? ` - ${order.address.neighborhood}` : ""}
                {order.address?.city || order.address?.uf ? `; ${order.address?.city || ''}${order.address?.city && order.address?.uf ? ' - ' : ''}${order.address?.uf || ''}` : ''}
