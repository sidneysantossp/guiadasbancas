  ...
  try {
    ...
    return data.map((banca: any) => {
      ...
      return {
        ...
        cover: banca.cover_image || 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=1200&q=60',
        avatar: banca.profile_image || 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=200&q=60',
