...
Obrigado pela preferência! 🙏`;
  ...
  return (
    <div className="space-y-4">
      ...
      <div 
        ref={receiptRef}
        className="mx-auto max-w-full overflow-hidden bg-[#f5f5dc] border-2 border-gray-400 p-4 font-mono text-sm sm:max-w-md sm:p-6"
      ...
      >
        ...
        <div className="text-center border-b-2 border-gray-400 pb-4 mb-4">
          ...
          <div className="text-xs mt-1 whitespace-pre-line break-words">{defaultBancaInfo.address}</div>
        ...
        <div className="mb-4">
          <div className="text-xs break-words">CLIENTE: {order.customer_name.toUpperCase()}</div>
          ...
          {order.items.map((item, index) => (
            <div key={index} className="mb-2">
              <div className="grid grid-cols-12 gap-1 text-xs">
                ...
                <div className="col-span-6" style={{ wordBreak: 'break-word' }}>{item.product_name.toUpperCase()}</div>
      ...
      <div className="flex flex-col justify-center gap-2 sm:flex-row">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-md bg-green-600 px-4 py-2 text-white transition-colors hover:bg-green-700 sm:w-auto"
        >
