...
export default function BancasPertoDeMimPageClient({
  ...
  const [apiBancas, setApiBancas] = useState<any[] | null>(initialBancasSafe);
  const [categoriesMap, setCategoriesMap] = useState<Map<string, string>>(() => buildCategoriesMap(initialCategories));
