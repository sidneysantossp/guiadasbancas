...
export default function WorldCupClusterLinks({
  ...
  const links = pickLinks(variant === "compact" ? 3 : 4);
  const cityLinks = WORLD_CUP_CITY_PAGES.slice(0, variant === "compact" ? 3 : 4);
  ...
  if (variant === "compact") {
    return (
      <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-6">
        ...
        <h3 className="mt-3 text-2xl font-bold text-slate-900">Continue a jornada do álbum e das figurinhas</h3>
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
      <div className="max-w-3xl">
        ...
        <h2 className="mt-3 text-3xl font-bold text-slate-900">Álbum, figurinhas e compra local em uma mesma arquitetura</h2>
