...
function MangaIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5 text-purple-600" fill="currentColor" aria-hidden>
        ...
        <div className="absolute inset-0 p-2">
          <div className="relative h-full w-full rounded-[14px] overflow-hidden">
            ...
            <Link
              ...
              className="absolute inset-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-600"
            />
            <div className="pointer-events-none absolute inset-0 bg-black/0 group-hover:bg-black/5 transition" />
            {discount > 0 && (
              <span className="absolute left-2 top-2 z-10 inline-flex items-center rounded-md bg-purple-600 text-white px-2 py-[2px] text-[11px] font-semibold shadow">
                -{discount}%
              </span>
            )}
          </div>
...
export default function PlanetMangaProducts() {
  ...
  const [apiItems, setApiItems] = useState<MangaProduct[]>([]);
    ...
    <section className="w-full pt-8 md:pt-10">
      <div className="container-max">
        <div className="mb-3 flex items-center gap-2">
          <MangaIcon />
          <h2 className="text-lg sm:text-xl font-semibold text-purple-600">Planet Manga</h2>
        </div>
